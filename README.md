...
[![Travis CI](https://travis-ci.org/greg-1-anderson/starter-test-65.svg?branch=master)](https://travis-ci.org/greg-1-anderson/starter-test-65)
[![Windows CI](https://ci.appveyor.com/api/projects/status/n5no03ucxaj72at4?svg=true)](https://ci.appveyor.com/project/greg-1-anderson/starter-test-65)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/greg-1-anderson/starter-test-65/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/greg-1-anderson/starter-test-65/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/greg-1-anderson/starter-test-65/badge.svg?branch=master)](https://coveralls.io/github/greg-1-anderson/starter-test-65?branch=master) 
...
[![License](https://poser.pugx.org/greg-1-anderson/starter-test-65/license)](https://github.com/greg-1-anderson/starter-test-65//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/greg-1-anderson/starter-test-65)
| Linux permutation testing | [DONE](https://travis-ci.org/greg-1-anderson/starter-test-65)
| Windows testing           | [DONE](https://ci.appveyor.com/project/greg-1-anderson/starter-test-65)
| Static analysis           | [DONE](https://scrutinizer-ci.com/g/greg-1-anderson/starter-test-65/)
...
deploy:
  ...
  on:
    tags: true
    repo: greg-1-anderson/starter-test-65
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/greg-1-anderson/starter-test-65/tags). 

## Authors

* **Greg Anderson** - created project from template.

See also the list of [contributors](https://github.com/greg-1-anderson/starter-test-65/contributors) who participated in this project.
